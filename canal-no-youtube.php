...
if (isset($_GET['sair'])) {
    ...
    header("location: https://www.musicanapraxis.com/canal-no-youtube.php");
	...
	<header>
		...
		<nav id="menu">
			...
			<ul>
				...
				<li><a href="https://www.musicanapraxis.com/canal-no-youtube.php" id="ativo">Canal no YouTube</a></li>
