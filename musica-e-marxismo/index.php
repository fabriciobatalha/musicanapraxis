...
if (isset($_GET['sair'])) {
    ...
    header("location: https://www.musicanapraxis.com/musica-e-marxismo/index.php");
...
<body>
		...
		<nav id="menu">
			...
			<ul>
				...
				<li class="menu">
					...
					<a href="https://www.musicanapraxis.com/musica-e-marxismo" id="ativo">M&uacute;sica e Marxismo</a>

					<a href="#" id="ativo">M&uacute;sica e Marxismo</a>

					<ul class="submenu">

						<li><a href="https://www.musicanapraxis.com/musica-e-marxismo" class="subativo">Todos</a></li>
	...
	<section>
		...
		<section class="art">
			...
			<h2><a href="https://www.musicanapraxis.com/musica-e-marxismo/relacoes-de-trabalho">Rela&ccedil;&otilde;es de Trabalho</a></h2>
		...
		<section class="art">
			...
			<h2><a href="https://www.musicanapraxis.com/musica-e-marxismo/sindicalismo-na-musica">Sindicalismo na M&uacute;sica</a></h2>

			<div>

				<?php

				foreach (getConexao()->query($artsSindicalismoNaMusica) as $row) {
