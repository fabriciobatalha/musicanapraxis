...
if (isset($_GET['sair'])) {
    ...
    header("location: https://www.musicanapraxis.com/musica-e-marxismo/relacoes-de-trabalho/artigo.php");
...
<body>
			...
			<ul>
				...
				<li class="menu">
					...
					<ul class="submenu">
						...
						<li><a href="https://www.musicanapraxis.com/musica-e-marxismo/relacoes-de-trabalho" class="subativo">Rela&ccedil;&otilde;es de Trabalho</a></li>
	...
	<section>
        ...
        <div class="breadcumb">
            ...
            <p><a href="https://www.musicanapraxis.com/musica-e-marxismo">M&uacute;sica e Marxismo</a> > <a href="https://www.musicanapraxis.com/musica-e-marxismo/relacoes-de-trabalho">Rela&ccedil;&otilde;es de Trabalho</a> > <a href="#" class="subativo"><?php echo getArtigo($_GET['artigo'])->artigo ?></a> </p>
