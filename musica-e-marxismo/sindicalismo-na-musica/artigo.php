...
if (isset($_GET['sair'])) {
    ...
    header("location: https://www.musicanapraxis.com/musica-e-marxismo/sindicalismo-na-musica/artigo.php");
...
<body>
			...
			<ul>
				...
				<li class="menu">
					...
					<ul class="submenu">
						...
						<li><a href="https://www.musicanapraxis.com/musica-e-marxismo/sindicalismo-na-musica" class="subativo">Sindicalismo na M&uacute;sica</a></li>
	...
	<section>
        ...
        <div class="breadcumb">
            ...
            <p><a href="https://www.musicanapraxis.com/musica-e-marxismo">M&uacute;sica e Marxismo</a> > <a href="https://www.musicanapraxis.com/musica-e-marxismo/sindicalismo-na-musica">Sindicalismo na M&uacute;sica</a> > <a href="#" class="subativo"><?php echo getArtigo($_GET['artigo'])->artigo ?></a> </p>
