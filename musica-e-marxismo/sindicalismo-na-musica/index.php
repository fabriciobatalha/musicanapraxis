...
if (isset($_GET['sair'])) {
    ...
    header("location: https://www.musicanapraxis.com/musica-e-marxismo/sindicalismo-na-musica/index.php");
...
<body>
			...
			<ul>
				...
				<li class="menu">
					...
					<ul class="submenu">
						...
						<li><a href="../relacoes-de-trabalho">Rela&ccedil;&otilde;es de Trabalho</a></li>

						<li><a href="#" class="subativo">Sindicalismo na M&uacute;sica</a></li>
	...
	<section>
        ...
        <div class="breadcumb">
            ...
            <p><a href="../">M&uacute;sica e Marxismo</a> > <a href="#" class="subativo">Sindicalismo na M&uacute;sica</a></p>

        </div>

		<h1>Sindicalismo na M&uacute;sica</h1>
