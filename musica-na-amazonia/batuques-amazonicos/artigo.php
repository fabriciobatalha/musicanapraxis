...
if (isset($_GET['sair'])) {
    ...
    header("location: https://www.musicanapraxis.com/musica-na-amazonia/batuques-amazonicos/artigo.php");
...
<body>
			...
			<ul>
				...
				<li class="menu">
					...
					<ul class="submenu">
						...
						<li><a href="https://www.musicanapraxis.com/musica-na-amazonia/batuques-amazonicos" class="subativo">Batuques Amaz&ocirc;nicos</a></li>
	...
	<section>
        ...
        <div class="breadcumb">
            ...
            <p><a href="https://www.musicanapraxis.com/musica-na-amazonia">M&uacute;sica na Amaz&ocirc;nia</a> > <a href="https://www.musicanapraxis.com/musica-na-amazonia/batuques-amazonicos/">Batuques Amaz&ocirc;nicos</a> > <a href="#" class="subativo"><?php echo getArtigo($_GET['artigo'])->artigo ?></a> </p>
