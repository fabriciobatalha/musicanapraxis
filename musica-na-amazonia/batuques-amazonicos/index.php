...
if (isset($_GET['sair'])) {
    ...
    header("location: https://www.musicanapraxis.com/musica-na-amazonia/batuques-amazonicos/index.php");
...
<body>
			...
			<ul>
				...
				<li class="menu">
					...
					<ul class="submenu">
						...
						<li><a href="#" class="subativo">Batuques Amaz&ocirc;nicos</a></li>
	...
	<section>
        ...
        <div class="breadcumb">
            ...
            <p><a href="../">M&uacute;sica na Amaz&ocirc;nia</a> > <a href="#" class="subativo">Batuques Amaz&ocirc;nicos</a></p>

        </div>

		<h1>Batuques Amaz&ocirc;nicos</h1>
