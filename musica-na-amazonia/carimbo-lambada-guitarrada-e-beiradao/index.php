...
if (isset($_GET['sair'])) {
    ...
    header("location: https://www.musicanapraxis.com/musica-na-amazonia/carimbo-lambada-guitarrada-e-beiradao/index.php");
...
<body>
			...
			<ul>
				...
				<li class="menu">
					...
					<ul class="submenu">
						...
						<li><a href="../batuques-amazonicos">Batuques Amaz&ocirc;nicos</a></li>

						<li><a href="#" class="subativo">Carimb&oacute;, Lambada, Guitarrada e Beirad&atilde;o</a></li>

						<li><a href="../musica-indigena">M&uacute;sica Ind&iacute;gena</a></li>
	...
	<section>
        ...
        <div class="breadcumb">
            ...
            <p><a href="../">M&uacute;sica na Amaz&ocirc;nia</a> > <a href="#" class="subativo">Carimb&oacute;, Lambada, Guitarrada e Beirad&atilde;o</a></p>

        </div>

		<h1>carimbo-lambada-guitarrada-e-beiradao</h1>
