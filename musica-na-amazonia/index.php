...
if (isset($_GET['sair'])) {
    ...
    header("location: https://www.musicanapraxis.com/musica-na-amazonia/index.php");
...
$ultArtigos = "SELECT id,artigo,data_cad FROM artigos WHERE topico_id = 3 ORDER BY id DESC LIMIT 3";

$artsBatuquesAmazonicos = "SELECT id,artigo,data_cad FROM artigos WHERE topico_id = 3 AND subtopico_id = 6 ORDER BY id DESC LIMIT 8";

$artsCarLamGui = "SELECT id,artigo,data_cad FROM artigos WHERE topico_id = 3 AND subtopico_id = 7 ORDER BY id DESC LIMIT 8";

$artsMusicaIndigena = "SELECT id,artigo,data_cad FROM artigos WHERE topico_id = 3 AND subtopico_id = 8 ORDER BY id DESC LIMIT 8";
...
<body>
		...
		<nav id="menu">
			...
			<ul>
				...
				<li class="menu">
					...
					<a href="#" id="ativo">M&uacute;sica na Amaz&ocirc;nia</a>
	...
	<section>
		...
		<h1>M&uacute;sica na Amazônia</h1>
		...
		<section class="art">
			...
			<h2><a href="https://www.musicanapraxis.com/musica-na-amazonia/batuques-amazonicos">Batuques Amaz&ocirc;nicos</a></h2>

			<div>

				<?php

				foreach (getConexao()->query($artsBatuquesAmazonicos) as $row) {
		...
		<section class="art">
			...
			<h2><a href="https://www.musicanapraxis.com/musica-na-amazonia/carimbo-lambada-guitarrada-e-beiradao">Carimb&oacute;, Lambada, Guitarrada e Beirad&atilde;o</a></h2>

			<div>

				<?php

				foreach (getConexao()->query($artsCarLamGui) as $row) {
		...
		<section class="art">
			...
			<h2><a href="https://www.musicanapraxis.com/musica-na-amazonia/musica-indigena">M&uacute;sica Ind&iacute;gena</a></h2>

			<div>

				<?php

				foreach (getConexao()->query($artsMusicaIndigena) as $row) {
