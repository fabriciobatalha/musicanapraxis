...
if (isset($_GET['sair'])) {
    ...
    header("location: https://www.musicanapraxis.com/musica-na-amazonia/musica-indigena/index.php");
...
<body>
			...
			<ul>
				...
				<li class="menu">
					...
					<ul class="submenu">
						...
						<li><a href="../carimbo-lambada-guitarrada-e-beiradao">Carimb&oacute;, Lambada, Guitarrada e Beirad&atilde;o</a></li>

						<li><a href="#" class="subativo">M&uacute;sica Ind&iacute;gena</a></li>
	...
	<section>
        ...
        <div class="breadcumb">
            ...
            <p><a href="../">M&uacute;sica na Amaz&ocirc;nia</a> > <a href="#" class="subativo">M&uacute;sica Ind&iacute;gena</a></p>

        </div>

		<h1>M&uacute;sica Ind&iacute;gena</h1>
