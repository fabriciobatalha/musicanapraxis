...
if (isset($_GET['sair'])) {
    ...
    header("location: https://www.musicanapraxis.com/musica-popular-e-erudita/autonomia-musica-e-canone/index.php");
...
$artsAutoMusCan = "SELECT id,artigo,data_cad FROM artigos WHERE topico_id = 2 AND subtopico_id = 5 ORDER BY id DESC LIMIT 3";
...
<body>
			...
			<ul>
				...
				<li class="menu">
					...
					<ul class="submenu">
						...
						<li><a href="../sec-xix-xx-xxi">S&eacute;c XIX, XX, XXI</a></li>

						<li><a href="../paradigma-nacional-republicano">Paradigma Nacional-Republicano</a></li>

						<li><a href="#" class="subativo">Autonomia da M&uacute;sica e C&acirc;none</a></li>
	...
	<section>
        ...
        <div class="breadcumb">
            ...
            <p><a href="../">M&uacute;sica Popular e Erudita</a> > <a href="#" class="subativo">Autonomia da M&uacute;sica e C&acirc;none</a></p>

        </div>

		<h1>Autonomia da M&uacute;sica e C&acirc;none</h1>
