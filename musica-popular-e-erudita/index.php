...
if (isset($_GET['sair'])) {
    ...
    header("location: https://www.musicanapraxis.com/musica-popular-e-erudita/index.php");
...
$ultArtigos = "SELECT id,artigo,data_cad FROM artigos WHERE topico_id = 2 ORDER BY id DESC LIMIT 3";

$artsSeculos = "SELECT id,artigo,data_cad FROM artigos WHERE topico_id = 2 AND subtopico_id = 3 ORDER BY id DESC LIMIT 8";

$artsParadigmaNacRep = "SELECT id,artigo,data_cad FROM artigos WHERE topico_id = 2 AND subtopico_id = 4 ORDER BY id DESC LIMIT 8";

$artsAutoMusCan = "SELECT id,artigo,data_cad FROM artigos WHERE topico_id = 2 AND subtopico_id = 5 ORDER BY id DESC LIMIT 8";
...
<head>
	...
	<link href="https://www.musicanapraxis.com/httpss://fonts.googleapis.com/css?family=Quicksand" rel="stylesheet">
...
<body>
		...
		<nav id="menu">
			...
			<ul>
				...
				<li class="menu">
					...
					<a href="#" id="ativo">M&uacute;sica Popular e Erudita</a>

					<a href="#" id="ativo">M&uacute;sica Popular e Erudita</a>

					<ul class="submenu">

						<li><a href="https://www.musicanapraxis.com/musica-popular-e-erudita" class="subativo">Todos</a></li>
				...
				<li class="menu">
					...
					<ul class="submenu">
						...
						<li><a href="./musica-na-amazonia">Todos</a></li>
	...
	<section>
		...
		<h1>M&uacute;sica Popular e Erudita</h1>
			...
			<div>
				...
				foreach (getConexao()->query($ultArtigos) as $row) {
					...
					echo "
						...
						<a title='{$row['artigo']}' href='".getURLArtigo($row['id'])."' class='arts'>
		...
		<section class="art">
			...
			<h2><a href="https://www.musicanapraxis.com/musica-popular-e-erudita/sec-xix-xx-xxi">S&eacute;c XIX, XX, XXI</a></h2>

			<div>

				<?php

				foreach (getConexao()->query($artsSeculos) as $row) {
		...
		<section class="art">
			...
			<h2><a href="https://www.musicanapraxis.com/musica-popular-e-erudita/paradigma-nacional-republicano">Paradigma Nacional-Republicano</a></h2>

			<div>

				<?php

				foreach (getConexao()->query($artsParadigmaNacRep) as $row) {
		...
		<section class="art">
			...
			<h2><a href="https://www.musicanapraxis.com/musica-popular-e-erudita/autonomia-musica-e-canone">Autonomia da M&uacute;sica e C&acirc;none</a></h2>

			<div>

				<?php

				foreach (getConexao()->query($artsAutoMusCan) as $row) {
