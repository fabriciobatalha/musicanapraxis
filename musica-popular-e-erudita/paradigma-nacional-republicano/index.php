...
if (isset($_GET['sair'])) {
    ...
    header("location: https://www.musicanapraxis.com/musica-popular-e-erudita/paradigma-nacional-republicano/index.php");
...
$artsParadigmaNacRep = "SELECT id,artigo,data_cad FROM artigos WHERE topico_id = 2 AND subtopico_id = 4 ORDER BY id DESC LIMIT 3";
...
<body>
		...
		<nav id="menu">
			...
			<li class="menu">
				...
				<ul class="submenu">
					...
					<li><a href="#" class="subativo">Paradigma Nacional-Republicano</a></li>
	...
	<section>
        ...
        <div class="breadcumb">
            ...
            <p><a href="../">M&uacute;sica Popular e Erudita</a> > <a href="#" class="subativo">Paradigma Nacional-Republicano</a></p>

        </div>

		<h1>Paradigma Nacional-Republicano</h1>
