...
if (isset($_GET['sair'])) {
    ...
    header("location: https://www.musicanapraxis.com/musica-popular-e-erudita/sec-xix-xx-xxi/index.php");
...
$artsSeculos = "SELECT id,artigo,data_cad FROM artigos WHERE topico_id = 2 AND subtopico_id = 3 ORDER BY id DESC LIMIT 3";
...
<body>
		...
		<nav id="menu">
			...
			<ul>
				...
				<li class="menu">
					...
					<a href="https://www.musicanapraxis.com/musica-popular-e-erudita" id="ativo">M&uacute;sica Popular e Erudita</a>
					...
					<ul class="submenu">
						...
						<li><a href="#" class="subativo">S&eacute;c XIX, XX, XXI</a></li>

						<li><a href="../paradigma-nacional-republicano">Paradigma Nacional-Republicano</a></li>

						<li><a href="../autonomia-musica-e-canone">Autonomia da M&uacute;sica e C&acirc;none</a></li>
	...
	<section>
        ...
        <div class="breadcumb">
            ...
            <p><a href="../">M&uacute;sica Popular e Erudita</a> > <a href="#" class="subativo">S&eacute;c XIX, XX, XXI</a></p>

        </div>

		<h1>S&eacute;c XIX, XX, XXI</h1>
				...
				foreach (getConexao()->query($artsSeculos) as $row) {
					...
					echo "
						...
						<a href='".getURLArtigo($row['id'])."' title='{$row['artigo']}'>
							...
							<article style='background-image: linear-gradient(rgba(0, 0, 0, 0.85), rgba(0, 0, 0, 0.85)), url(".str_replace(",", "", getURLImagemArtigo($row['id'])).");'>
